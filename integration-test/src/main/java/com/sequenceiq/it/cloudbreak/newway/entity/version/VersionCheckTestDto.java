package com.sequenceiq.it.cloudbreak.newway.entity.version;
...
@Prototype
public class VersionCheckTestDto extends AbstractCloudbreakEntity<Object, VersionCheckV4Result, VersionCheckTestDto> {
