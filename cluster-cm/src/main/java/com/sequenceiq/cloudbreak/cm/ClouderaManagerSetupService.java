...
public class ClouderaManagerSetupService implements ClusterSetupService {
    ...
    @Override
    public Cluster buildCluster(Map<HostGroup, List<InstanceMetaData>> instanceMetaDataByHostGroup, String blueprintText,
...
// = postgresConfigService.createRdsConfigIfNeeded(stack, cluster);
            Set<RDSConfig> rdsConfigs = Collections.emptySet();
